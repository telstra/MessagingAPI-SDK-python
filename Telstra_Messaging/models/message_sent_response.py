...
class MessageSentResponse(object):
    ...
    def __init__(self, messages=None, country=None, message_type=None, number_segments=None):  # noqa: E501
        """MessageSentResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def country(self):
        """Gets the country of this MessageSentResponse.  # noqa: E501
    ...
    def country(self, country):
        """Sets the country of this MessageSentResponse.
    ...
    def number_segments(self):
        ...
        For SMS messages only, the value indicates the number of 160 character message segments sent.   # noqa: E501
