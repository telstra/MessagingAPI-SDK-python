...
class SendMmsRequest(object):
    ...
    def __init__(self, to=None, _from=None, subject=None, reply_request=None, notify_url=None, mms_content=None, local_vars_configuration=None):  # noqa: E501
