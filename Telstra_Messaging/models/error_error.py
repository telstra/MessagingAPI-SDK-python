...
class ErrorError(object):
    ...
    @property
    def status(self):
        """Gets the status of this ErrorError.  # noqa: E501

        A short error code  # noqa: E501

        :return: The status of this ErrorError.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ErrorError.

        A short error code  # noqa: E501

        :param status: The status of this ErrorError.  # noqa: E501
        :type: str
        """
        if status is None:
