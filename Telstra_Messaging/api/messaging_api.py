...
class MessagingApi(object):
    ...
    def m_ms_health_check(self, **kwargs):  # noqa: E501
        """MMS Health Check  # noqa: E501

        Determine whether the MMS service is up or down.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.m_ms_health_check(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.m_ms_health_check_with_http_info(**kwargs)  # noqa: E501

    def m_ms_health_check_with_http_info(self, **kwargs):  # noqa: E501
        """MMS Health Check  # noqa: E501

        Determine whether the MMS service is up or down.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.m_ms_health_check_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method m_ms_health_check" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def s_ms_health_check(self, **kwargs):  # noqa: E501
        """SMS Health Check  # noqa: E501

        Determine whether the SMS service is up or down.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_ms_health_check(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.s_ms_health_check_with_http_info(**kwargs)  # noqa: E501

    def s_ms_health_check_with_http_info(self, **kwargs):  # noqa: E501
        """SMS Health Check  # noqa: E501

        Determine whether the SMS service is up or down.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_ms_health_check_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method s_ms_health_check" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def s_ms_multi(self, payload, **kwargs):  # noqa: E501
        """Send Multiple SMS  # noqa: E501

        Send multiple SMS in one API call.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_ms_multi(payload, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.s_ms_multi_with_http_info(payload, **kwargs)  # noqa: E501

    def s_ms_multi_with_http_info(self, payload, **kwargs):  # noqa: E501
        """Send Multiple SMS  # noqa: E501

        Send multiple SMS in one API call.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_ms_multi_with_http_info(payload, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('payload' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `payload` when calling `s_ms_multi`")  # noqa: E501
