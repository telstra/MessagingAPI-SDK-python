...
class MessagingApi(object):
    ...
    def retrieve_mms_responses(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.retrieve_mms_responses(async=True)
        >>> result = thread.get()
    ...
    def retrieve_mms_responses_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.retrieve_mms_responses_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def send_mms(self, send_mms_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.send_mms(send_mms_request, async=True)
        >>> result = thread.get()

        :param async bool
        :param SendMmsRequest send_mms_request: A JSON or XML payload containing the recipient's phone number and MMS message. The recipient number should be in the format '04xxxxxxxx' where x is a digit.
 (required)
    ...
    def send_mms_with_http_info(self, send_mms_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.send_mms_with_http_info(send_mms_request, async=True)
        >>> result = thread.get()
 ...
 (required)
        ...
        if ('send_mms_request' not in params or
                params['send_mms_request'] is None):
        ...
        body_params = None
        if 'send_mms_request' in params:
            body_params = params['send_mms_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def send_sms(self, send_sms_request, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param SendSMSRequest send_sms_request: A JSON or XML payload containing the recipient's phone number and text message. This number can be in international format if preceeded by a '+' or in national format ('04xxxxxxxx') where x is a digit.
 (required)
        :return: MessageSentResponse
                 If the method is called asynchronously,
                 returns the request thread.
