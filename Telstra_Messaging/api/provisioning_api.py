...
class ProvisioningApi(object):
    ...
    def create_subscription(self, provision_number_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.create_subscription_with_http_info(provision_number_request, **kwargs)  # noqa: E501
        else:
            (data) = self.create_subscription_with_http_info(provision_number_request, **kwargs)  # noqa: E501
            return data

    def create_subscription_with_http_info(self, provision_number_request, **kwargs):  # noqa: E501
        """Create Subscription  # noqa: E501

        Invoke the provisioning API to get a dedicated mobile number for an account or application. Note that Free Trial apps will have a 30-Day Limit for their provisioned number. If the Provisioning call is made several times within that 30-Day period, it will return the `expiryDate` in the Unix format and will not add any activeDays until after that `expiryDate`.  For paid apps, a provisioned number can be allotted for a maximum of 5 years. If a Provisioning call is made which will result to activeDays > 1830, the response body will indicate that the provisioned number is already valid for more than 5 years.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_subscription_with_http_info(provision_number_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['provision_number_request']  # noqa: E501
        ...
        if ('provision_number_request' not in local_var_params or
                local_var_params['provision_number_request'] is None):
            raise ValueError("Missing the required parameter `provision_number_request` when calling `create_subscription`")  # noqa: E501
        ...
        body_params = None
        if 'provision_number_request' in local_var_params:
            body_params = local_var_params['provision_number_request']
        # HTTP header `Accept`
    ...
    def delete_subscription(self, delete_number_request, **kwargs):  # noqa: E501
        """Delete Subscription  # noqa: E501

        Delete a mobile number subscription from an account   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_subscription(delete_number_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DeleteNumberRequest delete_number_request: EmptyArr (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_subscription_with_http_info(delete_number_request, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_subscription_with_http_info(delete_number_request, **kwargs)  # noqa: E501
            return data

    def delete_subscription_with_http_info(self, delete_number_request, **kwargs):  # noqa: E501
        """Delete Subscription  # noqa: E501

        Delete a mobile number subscription from an account   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_subscription_with_http_info(delete_number_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['delete_number_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('delete_number_request' not in local_var_params or
                local_var_params['delete_number_request'] is None):
            raise ValueError("Missing the required parameter `delete_number_request` when calling `delete_subscription`")  # noqa: E501
        ...
        body_params = None
        if 'delete_number_request' in local_var_params:
            body_params = local_var_params['delete_number_request']
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json'])  # noqa: E501
