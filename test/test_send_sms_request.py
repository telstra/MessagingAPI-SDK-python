...
from Telstra_Messaging.models.send_sms_request import SendSMSRequest  # noqa: E501
...
class TestSendSMSRequest(unittest.TestCase):
    ...
    def testSendSMSRequest(self):
        ...
        # model = Telstra_Messaging.models.send_sms_request.SendSMSRequest()  # noqa: E501
        pass
